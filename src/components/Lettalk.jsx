...
function Lettalk() {
  ...
  return (
    <section className="relative bg-white dark:bg-transparent py-20 px-4 md:px-12" id="contact">
      {/* Decorative Shapes */}
      <div className="absolute top-0 left-0 z-0 w-64 pointer-events-none select-none">
        <img src={shape1} alt="Top Shape" className="w-full h-auto" />
      </div>
      <div className="absolute bottom-0 right-0 z-0 w-64 pointer-events-none select-none scale-x-[-1]">
